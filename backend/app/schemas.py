...
class PromptInput(BaseModel):
    """
    Schema for prompt input data.
    """
    model: Literal["gemini-2.0-flash"] = Field("gemini-2.0-flash", description="Model to use for generation")
    prompt: str = Field(..., description="Prompt text for the model")
    
class PromptOutput(BaseModel):
    "Schema for prompt output data."
    text: str = Field(..., description="Response text generated by the model")
